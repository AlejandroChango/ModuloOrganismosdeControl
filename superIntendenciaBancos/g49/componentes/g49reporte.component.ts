...
@Component({
  selector: 'app-g49Reporte',
  templateUrl: 'g49Reporte.html'
})
export class g49ReporteComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(public localStorageService: LocalStorageService, router: Router, dtoServicios: DtoServicios, private excelService:ExcelService) {
    super(localStorageService, router, dtoServicios, '', 'REPORTEG49', false);
  ...
  public generarReporte() {
    this.rqConsulta.CODIGOCONSULTA = 'OC_G49REPORTE';
    this.rqConsulta.storeprocedure = "sp_OdcRptReporteg49SuperB";
    ...
    this.dtoServicios.ejecutarConsultaRest(this.rqConsulta)
      .subscribe(
        resp => {
          ...
          this.lregistros = resp.OC_G49REPORTE;
        },
        error => {
  ...
  imprimir(): void {
      ...
      if (this.lregistros.hasOwnProperty(i)) {
        ...
        if (reg.idSujeto !== undefined && reg.idSujeto !== null) {
          ...
          data += reg.tipoIdSujeto + separador +
                  ...
                  reg.fechaCancelacion + separador +
                  reg.formaCancelacion + salto;
          contador++;
        }
      }
    }
    ...
    var cabecera = 'G49' + separador + codigoSB + separador + fechaUltimoDia + '/' + m + '/' + this.mfiltros.fperiodo;
    ...
    linkElement1.download = "G49" + "M" + codigoSB + fechaUltimoDia + m + this.mfiltros.fperiodo + '.' + "txt";
  ...
  imprimirExcel(): void {
      ...
      if (this.lregistros.hasOwnProperty(i)) {
        ...
        if (reg.idSujeto !== undefined && reg.idSujeto !== null) {
          ...
          dataObj = {tipoIdSujeto: reg.tipoIdSujeto,
            ...
            fechaCancelacion: reg.fechaCancelacion,
            formaCancelacion: reg.formaCancelacion
          }
    ...
    var m = this.mfiltros.finicio < 10 ? "0" + this.mfiltros.finicio : this.mfiltros.finicio
    let nombreArchivo = "G49" + "M" + codigoSB + fechaUltimoDia + m + this.mfiltros.fperiodo;
